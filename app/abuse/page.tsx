...
export default function ReportAbuse() {
    return (
        <main className="min-h-screen bg-[#0C0806] flex flex-col items-center justify-center relative overflow-hidden text-center px-4">
            ...
            <h1 className="text-4xl md:text-5xl font-serif font-bold text-[#D4AF37] mb-4">Report Abuse</h1>
            <p className="text-[#F5E6D3] text-lg max-w-md">
                We take abuse seriously. Please report any issues to vedicmate@gmail.com
            </p>
        </main>
    )
}
